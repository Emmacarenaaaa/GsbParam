...
<div id="produits">
	...
	foreach ($lesProduitsDuPanier as $unProduit) {
		...
		<div id="card">
			...
			<div class="imgCard"><a href="index.php?uc=gererPanier&produit=<?= $id ?>&action=supprimerUnProduit"
...
<div class="contenuCentre">
	<a href="index.php?uc=gererPanier&action=passerCommande"><button type="button"
			class="btn btn-primary">Commander</button></a>
	<a href="index.php?uc=gererPanier&action=viderPanier"
		onclick="return confirm('Voulez-vous vraiment vider tout le panier ?');">
